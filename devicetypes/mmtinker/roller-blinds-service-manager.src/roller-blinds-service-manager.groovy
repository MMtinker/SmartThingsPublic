/**
 *  Created from generic UPnP Service Manager
 *
 ...
 */
definition(
		name: "Roller Blinds Service Manager",
		namespace: "MMtinker",
		author: "MMtinker",
		description: "Service Manager for connection to ESP8266 over wifi and detection with SSDP",
...
preferences {
	page(name: "searchTargetSelection", title: "UPnP Search Target", nextPage: "deviceDiscovery") {
		section("Search Target") {
			input "searchTarget", "string", title: "Search Target", defaultValue: "urn:schemas-upnp-org:device:RollerBlinds:1", required: true
		}
	}
	page(name: "deviceDiscovery", title: "ESP8266 Device Setup", content: "deviceDiscovery")
}
